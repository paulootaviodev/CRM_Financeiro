    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marked_for_deletion', models.BooleanField(default=False, verbose_name='Marcado para exclusão')),
                ('slug', models.SlugField(blank=True, editable=False, max_length=128, unique=True, verbose_name='Slug')),
                ('deletion_request_date', models.DateField(blank=True, null=True, verbose_name='Data de solicitação de exclusão')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('0001', 'Gerada'), ('0002', 'Enviada para o cliente'), ('0003', 'Aceita'), ('0004', 'Recusada'), ('0005', 'Expirada'), ('0006', 'Cancelada'), ('0008', 'Paga na conta do cliente')], max_length=4, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_canceled', models.BooleanField(default=False, verbose_name='Está cancelado')),
                ('slug', models.SlugField(blank=True, editable=False, max_length=128, unique=True, verbose_name='Slug')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Data Criado')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Data Atualizado')),
