"""
Django settings for crm_financeiro project.
...
ROOT_URLCONF = 'crm_settings.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'crm_financeiro' / 'templates',
...
WSGI_APPLICATION = 'crm_settings.wsgi.application'
